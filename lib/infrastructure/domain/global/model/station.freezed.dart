...
class _$StationImpl implements _Station {
  ...
  @override
  String toString() {
    return 'Station(id: $id, org: $org, orgKey: $orgKey, depth: $depth, refKey: $refKey, description: $description, docType: $docType, name: $name, rel: $rel, displayName: $displayName)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.refKey, refKey) || other.refKey == refKey) &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, org, orgKey, depth, refKey,
      description, docType, name, rel, displayName);
...
abstract class _Station implements Station {
  factory _Station(
      ...
      required final String refKey,
      final String? description,
      required final String docType,
      required final String name,
      required final String rel,
      required final String displayName}) = _$StationImpl;
