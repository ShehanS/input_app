    ...
    return MultiBlocProvider(providers: [
      ...
      builder: (innerContext, innerState) {
        return MaterialApp(
          ...
          locale: innerState.local, // Ensure this matches the property in LocalizationState
          localizationsDelegates: const [
            AppLocalizations.delegate, // Ensure this is properly set up
            GlobalMaterialLocalizations.delegate,
            GlobalWidgetsLocalizations.delegate,
            GlobalCupertinoLocalizations.delegate, // Added this for iOS localizations
          ],
